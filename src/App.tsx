            ...
            {activeTab === "rust" && (
              ...
              >
                <div className="flex justify-between items-center border-b border-slate-800 pb-1.5">
                  <div>
                    <h2 className="text-xs font-bold uppercase tracking-wider text-slate-200 font-mono">tiny11-rust-engine::LLVM_Core</h2>
                    <p className="text-[11px] text-slate-500">Cross-Platform (Linux / MacOS / Windows) Rust builder utilizing wimlib APIs for seamless file allocation</p>
                  </div>
                  <div className="flex gap-1">
                    <button 
                      onClick={() => downloadFile("main.rs", RUST_MAIN_CODE)}
                      className="px-2 py-0.5 bg-slate-950 hover:bg-slate-900 border border-slate-800 rounded font-mono text-[10px] text-orange-400 cursor-pointer"
                    >
                      get main.rs
                    </button>
                    <button 
                ...
                <div className="bg-slate-950 p-2.5 rounded border border-orange-500/15 text-[10.5px] text-slate-400 leading-normal gap-2 flex items-start">
                  ...
                  <span>
                    To execute native builds locally without kernel partition privileges, use our open rust compiler engine. Point the command line to any generic extracted image sources directory. Complete instructions are embedded inside the README documentation tab below.
                  </span>
                </div>

                {/* main.rs code display block */}
                <div className="flex flex-col gap-1">
                ...
                <div className="bg-slate-950 p-3 rounded border border-slate-800 flex flex-col gap-1">
                  ...
                  <div className="text-[11px] text-slate-450 leading-relaxed space-y-1.5 text-slate-400">
